...
// Creating styles using useMemo for optimization
const useStyles = () =>
  useMemo(
    () =>
      StyleSheet.create({
...
// InvoicePDF component definition
const InvoicePDF = ({ currentStatus, invoice }) => {
  // Destructuring props
  const {
    items,
    taxes,
      ...
      <Page size="A4" style={styles.page}>
        ...
        {/* <View style={styles.table}>
          ...
          <View>
            ...
            <View style={[styles.tableRow, styles.noBorder]}>
              ...
              <View style={[styles.tableCell_3, styles.alignRight]}>
                <Text style={styles.body2}>{fCurrency(-discount)}</Text>
              </View>
            </View>
            ...
            <View style={[styles.tableRow, styles.noBorder]}>
              ...
              <View style={[styles.tableCell_3, styles.alignRight]}>
                <Text style={styles.body2}>{fCurrency(taxes)}</Text>
              </View>
            </View>
        ...
        <View style={[styles.gridContainer, styles.footer]} fixed>
          ...
          <View style={[styles.col4, styles.alignRight]}>
            ...
            <Text style={styles.body2}>support@abcapp.com</Text>
          </View>
        </View>
      </Page>
    </Document>
