...
export default function SaleView({ currentUser }) {
            ...
            <Grid xs={12} md={12}>
              <Card sx={{ p: 3 , mb : 5 }}>
                ...
                <RHFAutocomplete
                  ...
                  <RHFTextField name="date" label="Date" type="date" />
                  <RHFTextField name="date" label="Total Sales - 0"  />
                  <RHFTextField name="date" label="Total Purchase - 0"  />
                  <RHFTextField name="date" label="Total Received - 0"  />
