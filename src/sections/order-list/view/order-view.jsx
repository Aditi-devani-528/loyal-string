...
const TABLE_HEAD = [
  ...
  { id: 'company', label: 'Box Name', width: 220 },
  { id: 'role', label: 'Packets', width: 180 },
  { id: 'role', label: 'Empty Weight', width: 180 },
...
export default function OrderView({ currentUser }) {
    ...
    <>
      <Container maxWidth={settings.themeStretch ? false : 'lg'}>
        <CustomBreadcrumbs
          ...
          //   //   href={paths.dashboard.report.boxcreate}
          //   //   variant="contained"
